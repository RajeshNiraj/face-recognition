...
class Register extends Component {
    ...
    render() {
        ...
        return(
            <article className="br3 ba b--black-10 
                            mv4 w-100 w-50-m   w-25-l mw6 shadow-5 center">
                    ...
                    <div className="measure">
                        <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                            ...
                            <div className="mv3">
                                ...
                                <FormInput onChange={this.onPasswordChange} 
                                    className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="password" name="password" 
                                 />                                  
                            </div>                    
                        </fieldset>
                        <div className="">
